            ...
            <?= form_open_multipart('user/quickemail'); ?>                    
               ...
               <?php elseif ($this->current_user_id == 67): ?>
                <button type="" disabled="true" class="btn btn-success m-t-20"><i class="fa fa-envelope-o"></i> Send</button>

               <?php else: ?>
                <button type="" class="btn btn-success m-t-20"><i class="fa fa-envelope-o"></i> Send</button>
              <?php endif; ?>
            <?= form_close(); ?>    
                                    </div>
                                </div>
