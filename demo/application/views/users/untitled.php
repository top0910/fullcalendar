...
<div class="row">
    <div class="col-lg-6">
        <div class="well">
            ...
            <?= form_input(['type'=>'hidden','name'=>'user_email','value'=>'admin@demo.com']); ?>
            ...
            <p><label for="email">Email</label>
                <?php echo form_input(['type'=>'email','class'=>'form-control','name'=>'user_email',
                    'id'=>'user_email','disabled'=>'TRUE','value'=>'admin@demo.com'
                    ]); ?></p>
...
<div class="col-lg-6">
    <div class="well">
        ...
        <p><label for="email">Email</label>
            <?= form_input(['type'=>'hidden','name'=>'user_email','value'=>'user@demo.com']); ?>
             <?= form_input(['type'=>'hidden','name'=>'user_password','value'=>'123']); ?>
            <?= form_input(['type'=>'email','class'=>'form-control','name'=>'user_email',
                'value'=>'user@demo.com','disabled'=>'TRUE'
                ]); ?></p>
                <div id="check_email"></div>
