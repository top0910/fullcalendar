  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        ...
        <?php elseif ($this->current_user_id == 67): ?>
          <?= form_submit(['value'=>'Submit','class'=>'btn btn-primary','disabled'=>'true']); ?>
    ...
    <div class="card">
      <div class="card-body">           
        ...
        <?php elseif ($this->current_user_id == 67): ?>
          <?= form_submit(['value'=>'Update','class'=>'btn btn-primary','disabled'=>'true']); ?>

        <?php else: ?>
          <?= form_submit(['value'=>'Update','class'=>'btn btn-info']); ?>
        <?php endif; ?>
...
<?php elseif ($this->current_user_id == 67): ?>
<td><button disabled="true" class="btn btn-danger btn-sm" href="<?= base_url('user/notice_delete?id='.$building_notice['id'])?>" onclick="if(confirm('Are your sure want to delete !'));else{ return false}"><span class="glyphicon glyphicon-trash"></span> Delete</button></td>
