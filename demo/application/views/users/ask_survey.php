                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="buttons-box clearfix">
                      ...
                      <a class="btn btn-success" type="submit">Start </a>    

                      <?php elseif ($this->current_user_role == 67): ?>
                        <a class="btn btn-success" type="" disabled="true">Start </a> 
                    ...
                    <div class="modal-header">
                      ...
                      <div class="buttons-box clearfix">
                        <?php if ($this->current_user_id == 67): ?>
                          <button class="btn btn-success" disabled="true" type="submit">Update Status </button> 
                          <?php else: ?>
...
<td><button disabled="true" class="btn btn-danger btn-sm" href="<?= base_url('user/survey_delete?id=' . $value['id']) ?>" onclick="if(confirm('Are your sure want to delete !'));else{ return false}"><span class="glyphicon glyphicon-trash"></span> Delete</button></td>
