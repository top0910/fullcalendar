    ...
    <div class="container" id="container-width">
        ...
        <nav class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right" id="top-nav">
                <li><a href="#" id="register_form">Strata365 Demo</a></li>
            </ul>
        </nav><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</div>
...
<!-- ******************************************* -->
                <br> 
                <center><h1 style="color: #000;">Welcome to Demo Page</h1></center>   
                <center><b><h2>View our demo in both admin and user roles to see just how easy our platform is</h2></center></b>
                <br>
<div class="row">
    <div class="col-lg-6">
        <div class="well">
            <h2>Building Admin Demo</h2>
            <?= form_open('user_login/login_submit'); ?>
            <?= form_input(['type'=>'hidden','name'=>'user_email','value'=>'admin@strata365.com']); ?>
             <?= form_input(['type'=>'hidden','name'=>'user_password','value'=>'123']); ?>
            <p><label for="email">Email</label>
                <?php echo form_input(['type'=>'email','class'=>'form-control','name'=>'user_email',
                    'id'=>'user_email','disabled'=>'TRUE','value'=>'admin@strata365.com'
                    ]); ?></p>
                    <div id="check_email"></div>

        <p><label for="password">Password</label>
    <?php echo form_password(['name'=>'user_password','class'=>'form-control','id'=>'user_password','disabled'=>'TRUE','value'=>'123'
                            ]); ?>
                            <br/></p>

                            <?php echo form_submit(['value'=>'Demo Login','id'=>'submit','class'=>'submit form-control btn btn-info']); ?>
                            <?php echo form_close(); ?> 
                            <br>            
                            Forgot Password ? 
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="buttons-box clearfix">
                                                <button class="btn btn-success" disabled="TRUE" type="submit">Reset Password</button>              
                                            </div>
                                            <?= form_close() ?>
                                        </div>
                                    </div>
...
<div class="col-lg-6">
    <div class="well">
        <h2>Building User Demo</h2>
        <?php echo form_open('user_login/login_submit'); ?>
        <p><label for="email">Email</label>
            <?= form_input(['type'=>'hidden','name'=>'user_email','value'=>'user@strata365.com']); ?>
             <?= form_input(['type'=>'hidden','name'=>'user_password','value'=>'123']); ?>
            <?= form_input(['type'=>'email','class'=>'form-control','name'=>'user_email',
                'value'=>'user@strata365.com','disabled'=>'TRUE'
                ]); ?></p>
                <div id="check_email"></div>

                <p><label for="password">Password</label>
                    <?php echo form_password(['name'=>'user_password','class'=>'form-control',
