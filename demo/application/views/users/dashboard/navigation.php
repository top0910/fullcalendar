                            ...
                            <nav class="sidebar-nav">
                                <ul id="sidebarnav">
                                    ...
                                    <?php if($this->session->userdata('user_role') == '0' 
                                        ...
                                        <li>
                                            <a class="waves-effect waves-dark collapse" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a>
                                        </li>
                                        <li>
                                    ...
                                    <?php if($this->session->userdata('user_role') == '0' OR $this->session->userdata('user_role') == '4'): ?>
                                        <li>
                                            <a class="waves-effect waves-dark collapse" href="<?=base_url()?>user/pm_docs" aria-expanded="false" ><i class="fa fa-book"></i><span class="hide-menu">Property Mgr Docs</span></a>
                                        </li>
                                    <?php endif; ?>
