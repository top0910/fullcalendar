...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109175580-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-109175580-1');
</script>
    <meta charset="utf-8">
    ...
    <title>Strata365 - Building Management Solutions</title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- Calendar CSS -->
    <link href="<?= base_url()?>assets/material-pro/assets/plugins/calendar/dist/fullcalendar.css" rel="stylesheet" />
...
<link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/bootstrap.daterangepicker/2/daterangepicker.css" />
    <!-- Chart JS -->
    <script src="<?= base_url()?>assets/material-pro/assets/plugins/Chart.js/chartjs.init.js"></script>
    <script src="<?= base_url()?>assets/material-pro/assets/plugins/Chart.js/Chart.min.js"></script>
    <script src="<?= base_url()?>assets/material-pro/assets/plugins/multiselect/multi-select.css"></script>
    ...
    <script src="<?= base_url()?>assets/material-pro/material/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="<?= base_url()?>assets/material-pro/material/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?= base_url()?>assets/material-pro/material/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    ...
    <!--Custom JavaScript -->
    <script src="<?= base_url()?>assets/material-pro/material/js/custom.min.js"></script>
    <!-- This is data table -->
    ...
    <script src="<?= base_url()?>assets/material-pro/assets/plugins/tinymce/tinymce.min.js"></script>
