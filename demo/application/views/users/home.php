            ...
            <table id="table_id" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        if(isset( $user_data['user_role']))
                        {
                          ...
                          elseif($user_role == 4){$role = '<span class="label label-inverse">Pro Manager</span>';}
                      ...
                      <div id="edit_user<?= $user_data['user_id'] ?>" class="modal fade" role="dialog">
                        ...
                        <div class="modal-footer">
                          <div class="buttons-box clearfix">
                            ...
                            <button class="btn btn-success" disabled="true" type="">Update User</button> 

                            <?php else: ?>
                            <button class="btn btn-success" type="">Update User</button> 
                            <?php endif; ?>             
                          </div>
                          <?= form_close() ?>
                ...
                <td> <!--Hide propery manager edit button from admin users-->
                    ...
                    <?php elseif($this->current_user_id == 67): ?>
                    <button class="btn btn-danger btn-sm" disabled="true" href="<?= base_url('user/user_delete?user_id=' . $user_data['user_id']) ?>" onclick="if(confirm('Are your sure want to delete !'));else{ return false}"><i class="mdi mdi-close-box"></i> Delete</button> 
