...
<section id="hero-area">
    ...
    <div class="row">
<!--     <img src="<?= base_url()?>assets/images/iconbar.jpg" alt="Our Services" style="width:100%; height: 90%; margin-bottom: -200px;"> -->

    <?php 
    if (empty($building_dashboard['icon_bar_image'])) { ?>
        <img src="<?=base_url()?>assets/images/iconbar.jpg" alt="icons" style="width:100%; height:90%; max-height: 200px; margin-bottom: -200px;">
    <?php }
    else
    { ?>
        <img src="<?= $building_dashboard['icon_bar_image'] ?>" alt="icons"  style="width:100%; height:90%; max-height: 200px; margin-bottom: -200px;">
    <? } ?>
...
<section id="price" class="section">
     ...
     <div class="price-bar"> Prices</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h4 class="text-center">Monthly Billing Package</h4>
                </div>
                <div class="panel-body text-center">
                    <p class="lead">
                        <strong>$36.50 / Month</strong>
                    </p>
                </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-info">
                <div class="panel-heading ">
                    <h4 class="text-center">Annual Package</h4>
                </div>
                <div class="panel-body text-center">
                    <p class="lead">
                        <strong> $365 Yearly</strong>
                    </p>
                </div>
                <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item">
