					...
					<small> - Attach pdf of meeting agenda</small></h4>
						<div class="box-body">
							...
							<div class="upload_button">
								<input type='submit' value='Upload' class='btn btn-success btn-md'>
							</div>
							<?php echo form_close(); ?>
...
<!-- ********************************** VIEW USER MODAL ENDS ************************************ -->
										...
										<td><a class="btn btn-danger btn-sm" href="<?= base_url('user/meeting_delete?id=' . $file_data['id']) ?>" onclick="if(confirm('Are your sure want to delete !'));else{ return false}"><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
