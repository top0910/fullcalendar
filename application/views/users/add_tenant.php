      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a class="btn btn-danger btn-sm" href="<?= base_url('user/tenant_delete?tenant_id=' . $tenant_data['user_id']) ?>" onclick="if(confirm('Are your sure want to delete !'));else{ return false}"><span class="glyphicon glyphicon-trash"></span> Delete</a>
    ...
    <div class="modal-body">
      ...
      <div class="modal-content">
        ...
        <div class="buttons-card clearfix">
          <button class="btn btn-success" type="submit">Update Tenant </button>              
        </div>
        <?= form_close() ?>
      </div>              
    </div>
