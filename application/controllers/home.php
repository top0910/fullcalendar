...
<section id="hero-area">
    ...
    <?php if ($building_dashboard['demo_graphic_image']) :?>
        <a href="https://strata365.com/demo/"><img src="<?= $building_dashboard['demo_graphic_image'] ?>" alt="icons"  style="width:100%; height:90%; max-height: 200px; margin-bottom: 0px;"></a>
    <?php endif; ?>
    </div></div>
